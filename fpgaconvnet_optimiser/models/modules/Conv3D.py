...
class Conv3D(Module3D):
    ...
    def __post_init__(self):
        ...
        if isinstance(self.kernel_size, int):
            ...
            assert len(self.kernel_size) == 3, "Must specify two kernel dimensions"
        else:
            raise TypeError
    ...
    def rate_in(self):
        return self.fine*self.groups/float(self.kernel_size[0]*self.kernel_size[1]*self.kernel_size[2]*self.filters)

    def rate_out(self):
        return self.fine/float(self.kernel_size[0]*self.kernel_size[1]*self.kernel_size[2])
